package net.riezebos.bruus.tbd.visuals.data.audio;
...
public class AudioDatabase {
    ...
    private List<CustomAudioClip> spaceStationChargingUpMovement = new ArrayList<CustomAudioClip>();
    private List<CustomAudioClip> spaceStationBlastingOff = new ArrayList<CustomAudioClip>();
    ...
    private void initSoundEffects () throws LineUnavailableException {
        ...
        CustomAudioClip spaceStationBlastingOffClip = new CustomAudioClip(AudioEnums.SpaceStationBlastingOff);
        spaceStationBlastingOff.add(spaceStationBlastingOffClip);
        audioClipsMap.put(AudioEnums.SpaceStationBlastingOff, spaceStationBlastingOff);

        CustomAudioClip spaceStationChargingMovementClip = new CustomAudioClip(AudioEnums.SpaceStationChargingUpMovement);
        spaceStationChargingUpMovement.add(spaceStationChargingMovementClip);
        audioClipsMap.put(AudioEnums.SpaceStationChargingUpMovement, spaceStationChargingUpMovement);
    }
