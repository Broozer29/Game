...
public class UpgradeSelectionBoardCreator {
    ...
    public static GUITextCollection createNepotismSelectionButton(GUIComponent backgroundCard) {
        ...
        if (Nepotism.getInstance().isUnlocked()) {
            text = Nepotism.getInstance().getUpgradeName();
        }
    ...
    public static MenuButton createNepotismUpgradeButton(GUIComponent backgroundCard, GUITextCollection nepotismSelectionButton) {
        ...
        ImageEnums imageType = ImageEnums.UpOrange;
        if (Nepotism.getInstance().getUpgradeCost() < PlayerProfileManager.getInstance().getLoadedProfile().getEmeralds() &&
                Nepotism.getInstance().canUpgradeFurther() && Nepotism.getInstance().isUnlocked()) {
        ...
        upgradeButton.setMenuFunctionality(MenuFunctionEnums.UpgradeNepotism);
        return upgradeButton;
    }

    public static GUITextCollection createSecondOption(GUIComponent button) {
        ...
        String text = "CLUB ACCESS";
        GUITextCollection nepotismSelectionButton = new GUITextCollection(xCoordinate, yCoordinate, text);
        nepotismSelectionButton.setScale(boonTextScale * DataClass.getInstance().getResolutionFactor());
        return nepotismSelectionButton;
    }

    public static GUITextCollection createThirdOption(GUIComponent button) {
        int xCoordinate = button.getXCoordinate();
        int yCoordinate = button.getYCoordinate() + Math.round(button.getHeight() * yDistanceBetweenButtons);

        String text = "INTEREST LOANS";
        GUITextCollection nepotismSelectionButton = new GUITextCollection(xCoordinate, yCoordinate, text);
        nepotismSelectionButton.setScale(boonTextScale * DataClass.getInstance().getResolutionFactor());
        return nepotismSelectionButton;
    }

    public static GUITextCollection createFourthOption(GUIComponent button) {
        int xCoordinate = button.getXCoordinate();
        int yCoordinate = button.getYCoordinate() + Math.round(button.getHeight() * yDistanceBetweenButtons);

        String text = "CONTRACT KILLER";
        GUITextCollection nepotismSelectionButton = new GUITextCollection(xCoordinate, yCoordinate, text);
        nepotismSelectionButton.setScale(boonTextScale * DataClass.getInstance().getResolutionFactor());
        return nepotismSelectionButton;
    }

    public static GUITextCollection createFifthOption(GUIComponent button) {
        int xCoordinate = button.getXCoordinate();
        int yCoordinate = button.getYCoordinate() + Math.round(button.getHeight() * yDistanceBetweenButtons);
    ...
    public static StartOfGameBoon getBoonFromByMenuFunctionality(MenuFunctionEnums menuFunctionality) {
