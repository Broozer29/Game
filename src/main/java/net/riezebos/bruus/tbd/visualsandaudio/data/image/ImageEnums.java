...
public enum ImageEnums {
    ...
    RoyalGuardGrenadier,
    RoyalGuardGuardsmen,
    RoyalGuardShieldbearer,
    RoyalGuardBarricadeMinion,
    FrontShield,
    GlassCannon,
    AnionInverter,
    BigIron,
    ...
    YellowBossHealCollision,
    YellowBossVoidMisisle,
    YellowBossVoidCollision,
    YellowBossVoidEffect,
    StickyDynamite,
    BarrierProjectile,
