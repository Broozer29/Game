...
import net.riezebos.bruus.tbd.game.gameobjects.enemies.enemytypes.bosses.blueboss.behaviour.BlueBossSpawnFactory;
import net.riezebos.bruus.tbd.game.gameobjects.enemies.enemytypes.bosses.blueboss.behaviour.BlueBossSpinningLaserbeamAttack;
...
public class BlueBoss extends Enemy {
    ...
    public BlueBoss(SpriteAnimationConfiguration spriteConfiguration, EnemyConfiguration enemyConfiguration, MovementConfiguration movementConfiguration) {
        ...
        BlueBossMissileAttack blueBossMissileAttack = new BlueBossMissileAttack();
        bossBehaviourList.add(blueBossMissileAttack);

        BlueBossSpawnFactory blueBossSpawnFactory = new BlueBossSpawnFactory();
        bossBehaviourList.add(blueBossSpawnFactory);

        BlueBossFireLaserbeams blueBossFireLaserbeams = new BlueBossFireLaserbeams();
        bossBehaviourList.add(blueBossFireLaserbeams);

        BlueBossSpinningLaserbeamAttack blueBossSpinningLaserbeamAttack = new BlueBossSpinningLaserbeamAttack();
        bossBehaviourList.add(blueBossSpinningLaserbeamAttack);
    ...
    public void fireAction() {
        ...
        if(this.allowedToMove && this.movementConfiguration.getPathFinder() instanceof FloatingPathFinder && this.getMovementConfiguration().getCurrentPath().getWaypoints().isEmpty()){
