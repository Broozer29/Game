...
public class StrikerBossMissileAttack implements BossActionable {
    ...
    private void updateChargingAttackAnimationLocation (Enemy enemy) {
        chargingAttackAnimation.setCenterCoordinates(
