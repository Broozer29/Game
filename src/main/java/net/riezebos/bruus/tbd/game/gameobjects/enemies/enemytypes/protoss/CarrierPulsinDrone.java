...
public class CarrierPulsinDrone extends Enemy {
    private static final int ANGLE_INCREMENT = 10;

    public CarrierPulsinDrone(SpriteAnimationConfiguration spriteConfig, EnemyConfiguration enemyConfiguration, MovementConfiguration movementConfiguration) {
