package net.riezebos.bruus.tbd.game.gameobjects.enemies.enemytypes.bosses.redboss;
...
public class RedBoss extends Enemy {
    ...
    private BossActionable inwardsAttack;
    private BossActionable outwardsAttack;
...
//        this.destructionAnimation.setAnimationScale(4);
    ...
    public void fireAction() {
        ...
        if (currentActiveBehavior != null) {
            ...
            if (isCompleted) {
                if(currentActiveBehavior.equals(inwardsAttack)){
                    currentActiveBehavior = outwardsAttack;
                } else {
