...
public class RoyalGuardFlagBearer extends Enemy {
    ...
    /*
        Vult dezelfde rol als de Tazer en Queen, hoverd op hetzelfde boardblock achter alle andere enemies
        Moet andere enemies buffen op een manier, weet nog niet hoe
            Attack speed buff? Healing? Of iets anders?
        Beweegt NIET uit het scherm, mag maar een X aantal van op het scherm zijn ten alle tijden
     */
