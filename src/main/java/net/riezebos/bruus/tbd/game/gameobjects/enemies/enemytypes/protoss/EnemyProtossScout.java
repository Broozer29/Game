...
public class EnemyProtossScout extends Enemy {
    private GameObject target;
    private int attackRange = 300;
    private float defaultMoveSpeed = 2.75f;
    private boolean isMovingSlow = false;
    private boolean justInitialized;
    private boolean wasFiringAtTarget = false;

    public EnemyProtossScout(SpriteAnimationConfiguration spriteAnimationConfigurationion, EnemyConfiguration enemyConfiguration, MovementConfiguration movementConfiguration) {
    ...
    private void shootMissile() {
        ...
        missile.setObjectType("Enemy Protoss Scout Missile");
