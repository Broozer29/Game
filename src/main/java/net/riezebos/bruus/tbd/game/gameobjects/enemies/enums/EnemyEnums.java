...
public enum EnemyEnums {
    ...
    ZergScourge(55, 0, false,
            ...
            3, 3, 0.75f, 1.75f, 1.4f, 31, 27,
            0),
    ZergMutalisk(145, 0, false,
    ...
    RoyalGuardBarricade(125, 0, true,
           AudioEnums.Large_Ship_Destroyed, "Royal Guard",
           ImageEnums.RoyalGuardBarricade, ImageEnums.Explosion2, 55, EnemyCategory.Medium, EnemyTribes.RoyalGuard, 10,
                   8, 15, 0.55f, 1, 1, 257, 170,
                   0),
    ...
    RoyalGuardCaptain(125, 0, true,
            ...
            8, 15, 0.55f, 1, 1, 201, 84,
            0),

    RoyalGuardFlagbearer(125, 0, true,
            AudioEnums.Large_Ship_Destroyed, "Royal Guard",
            ImageEnums.RoyalGuardFlagbearer, ImageEnums.Explosion2, 55, EnemyCategory.Medium, EnemyTribes.RoyalGuard, 10,
            8, 15, 0.55f, 1, 1, 175, 61,
            0),
    ...
    RoyalGuardGrenadier(125, 0, true,
            ...
            8, 15, 0.55f, 1, 1, 190, 128,
            0),

    RoyalGuardGuardsmen(125, 0, true,
            AudioEnums.Large_Ship_Destroyed, "Royal Guard",
            ImageEnums.RoyalGuardGuardsmen, ImageEnums.Explosion2, 55, EnemyCategory.Medium, EnemyTribes.RoyalGuard, 10,
            8, 15, 0.55f, 1, 1, 177, 67,
            0),


    RoyalGuardShieldbearer(125, 0, true,
            AudioEnums.Large_Ship_Destroyed, "Royal Guard",
            ImageEnums.RoyalGuardShieldbearer, ImageEnums.Explosion2, 55, EnemyCategory.Medium, EnemyTribes.RoyalGuard, 10,
            8, 15, 0.55f, 1, 1, 221, 122,
            0),
