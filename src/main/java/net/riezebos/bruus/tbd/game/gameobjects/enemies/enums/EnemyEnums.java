...
public enum EnemyEnums {
    ...
    ZergDevourer(175, 0, true,
            ...
            12, 15, 0.55f, 1.3f, 1, 66, 54,
            0),

    ZergGuardian(150, 0, true,
    ...
    ShurikenMiniBoss(550, 0, false,
            ...
            125, 100, 1, 2f, 1, 600, 600,
            0),

    MotherShipMiniBoss(550, 0, false,
    ...
    MirageMiniBoss(450, 0, true,
            ...
            125, 100, 1, 1.65f, 0.8f, 154, 99,
            0),

    DefenderMiniBoss(550, 0, true,
            ...
            125, 100, 1, 1, 1, 250, 250,
            0),

    LaserbeamMiniBoss(550, 0, true,
