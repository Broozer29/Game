...
public enum EnemyEnums {
    ...
    StrikerBossCornerDrone(99999999, 0, true,
            ...
            ImageEnums.StrikerCornerDrone, ImageEnums.Explosion2, 0, EnemyCategory.Summon, EnemyTribes.Pirates, 0,
            0,0, 0, 1, 1f, 118, 66,
            0),
    ...
    BlueBossFactory(250, 0, true,
            AudioEnums.Alien_Spaceship_Destroyed, "StrikerBoss Laserbeam Clone",
            ImageEnums.BlueBossFactory, ImageEnums.Explosion2, 0, EnemyCategory.Summon, EnemyTribes.Pirates, 0,
            0,0, 0, 0.15f, 1f, 323, 149,
            0),

    BlueBossFactoryDefender(250, 0, true,
            AudioEnums.Alien_Spaceship_Destroyed, "StrikerBoss Laserbeam Clone",
            ImageEnums.BlueBossFactoryDefender, ImageEnums.Explosion2, 0, EnemyCategory.Summon, EnemyTribes.Pirates, 0,
            0,0, 0, 4, 0.5f, 92, 57,
            0),
    ...
    LaserOriginDrone(125, 0, false,
            ...
            ImageEnums.Test_Image, ImageEnums.Explosion2, 0, EnemyCategory.Summon, EnemyTribes.Pirates, 0,
