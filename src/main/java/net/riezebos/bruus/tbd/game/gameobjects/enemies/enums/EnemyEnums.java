...
public enum EnemyEnums {
    ...
    Flamer(150, 0, true,
            ...
            16, 15, 0.6f, 1, 1, 137, 61,
            1),
    Bomba(200, 0, true,
            AudioEnums.Large_Ship_Destroyed, "Enemy Bomba",
            ImageEnums.Bomba, ImageEnums.Explosion2, 45, EnemyCategory.Medium, EnemyTribes.Pirates, 20,
            16, 15, 0.4f, 1, 1, 140, 75,
            2),
    Needler(50, 0, false,
            AudioEnums.Alien_Spaceship_Destroyed, "Enemy Needler",
            ImageEnums.Needler, ImageEnums.Explosion2, 25, EnemyCategory.Small, EnemyTribes.Pirates, 10,
    ...
    CashCarrier(200, 0, false,
            ...
            10, 40, 0, 1.25f, 0.75f, 171, 98,
            0),
    Scout(50, 0, true,
            AudioEnums.Alien_Spaceship_Destroyed, "Enemy Scout",
            ImageEnums.Scout, ImageEnums.Explosion2, 25, EnemyCategory.Small, EnemyTribes.Pirates, 10,
    ...
    ZergQueen(250, 0, true,
            ...
            0),
    ZergScourge(65, 0, false,
            AudioEnums.ScourgeDeath, "Zerg Scourge",
            ImageEnums.ScourgeIdle, ImageEnums.ScourgeDeath, 20, EnemyCategory.Small, EnemyTribes.Zerg, 0,
            4, 3, 0.75f, 1.75f, 1.2f, 31, 27,
            0),
    ZergMutalisk(150, 0, true,
            AudioEnums.MutaliskDeath, "Zerg Guardian",
            ImageEnums.MutaliskIdle, ImageEnums.MutaliskDeath, 15, EnemyCategory.Small, EnemyTribes.Zerg, 10,
            7.5f, 15, 0.7f, 1.75f, 1, 64, 72,
            0),
