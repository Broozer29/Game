...
public class LevelSelectionBoard extends JPanel implements ActionListener {
	...
	private void initMenuTiles() {
		...
		float imageScale = 1;
		float textScale = 1;
		this.dummyTest = new MenuObjectCollection(boardWidth / 2 - 100, 200, textScale, "LEVEL SELECTION",
		...
		//Create 3 cards, one for albums, the other for individual levels, the last one for starting the game
