...
public class DefaultPlayerLaserbeam extends Missile {
	...
	public DefaultPlayerLaserbeam(int x, int y, Point destination, ImageEnums missileType, ImageEnums explosionType, Direction rotation,
			float scale, PathFinder pathFinder, float damage, int xMovementSpeed, int yMovementSpeed) {
		super(x, y, destination, missileType, explosionType, rotation, scale, pathFinder, true, xMovementSpeed, yMovementSpeed);
