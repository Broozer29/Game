...
public enum EnemyEnums {
    ...
    Tazer(100, 0, true,
            ...
            ImageEnums.Tazer, ImageEnums.Explosion2, 50, EnemyCategory.Mercenary, false, 10, 1,
            4, 0.5f, 1, 1,94,34),
    Energizer(100, 0, true,
            false, AudioEnums.Large_Ship_Destroyed, "Enemy Energizer", 7f,
            ImageEnums.Energizer, ImageEnums.Explosion2, 50, EnemyCategory.Mercenary, false, 10, 1,
            4, 0.5f, 1, 1, 106, 39),
    Bulldozer(150, 0, false,
            false, AudioEnums.Large_Ship_Destroyed, "Enemy Bulldozer", 0,
            ImageEnums.Bulldozer, ImageEnums.Explosion2, 40, EnemyCategory.Mercenary, false, 20, 2,
            6, 0.4f, 1, 1, 119, 46),
    Flamer(150, 0, true,
            false, AudioEnums.Large_Ship_Destroyed, "Enemy Flamer", 6f,
            ImageEnums.Flamer, ImageEnums.Explosion2, 40, EnemyCategory.Mercenary, false, 10, 2,
            6, 0.5f, 1, 1, 137, 61),
    Bomba(150, 0, true,
            false, AudioEnums.Large_Ship_Destroyed, "Enemy Bomba", 7f,
            ImageEnums.Bomba, ImageEnums.Explosion2, 60, EnemyCategory.Mercenary, false, 20, 2,
            8, 0.3f, 1, 1,140, 75),
