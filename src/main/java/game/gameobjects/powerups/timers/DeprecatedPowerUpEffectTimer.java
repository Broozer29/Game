...
//
//public class DeprecatedPowerUpEffectTimer implements TimerInterface {
//    //Deprecated and should not be used, use regular effects instead
...
//
//    public DeprecatedPowerUpEffectTimer (float timeBeforeActivation, PowerUp powerUp, boolean loopable) {
