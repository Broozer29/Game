...
// Perhaps to be an entirely deleted method/class/functionality
public class CurvedPathFinder implements PathFinder {
    ...
    private void calculateMaxYCoordinate(Point current, Point end) {
    	int distanceBetween = Math.abs(current.getX() - end.getX());
    	int maxYIncrease = distanceBetween / 2;
